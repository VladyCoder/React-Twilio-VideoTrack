...
export const STOP_SCREEN_SHARE_TEXT = 'Finalizar compartir pantalla';
export const SHARE_IN_PROGRESS_TEXT = 'No se puede compartir la pantalla cuando otro usuario está compartiendola';
export const SHARE_NOT_SUPPORTED_TEXT = 'El uso compartido de pantalla no es compatible con este navegador';
